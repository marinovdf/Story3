...
$(document).ready(function () {
    ...
    function Move() {
        ...
        if ($bg6.hasClass("inview")) {bg6.css({'backgroundPosition': newPos(50, windowHeight, pos, 100, 0.1)});}
        if ($bg7.hasClass("inview")) {bg7.css({'backgroundPosition': newPos(50, windowHeight, pos, 0, 0.5)});}
